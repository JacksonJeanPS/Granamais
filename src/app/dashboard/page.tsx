...
export default async function Page() {
  ...
  const [profileResult, accountsResult, transactionsResult, invoicesResult, goalsResult] = await Promise.all([
    ...
    supabase.from("transactions").select("tipo,valor,data_competencia,status").eq("user_id", userId).neq("status", "cancelada").gte("data_competencia", historyStart).lt("data_competencia", nextMonth),
